...
1. di Blade Form tanggal di pembelian belakang name tgl sampai dan tgldari done
2. example laporancontroller latest diganti orderby('tgl'); done
3. periode yg kas blm done
4. Title dibagusin (blade title)
